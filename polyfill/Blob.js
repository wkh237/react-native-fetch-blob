...
export default class Blob extends EventTarget {
     ...
     * @param  {any} cType
     * @param  {boolean} defer When this argument set to `true`, blob constructor will not invoke blob created event
     * automatically.
     */
    constructor (data: *, cType: *, defer: boolean) {
        super();
        cType = cType || {};
     ...
     * @nonstandard
     * @param  {function(Blob)} fn An event handler invoked when Blob created
